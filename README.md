...
<!--
Version [0.y.z](https://github.com/mineiros-io/terraform-aws-lb-target-group/tree/v0.0.2) of this module is the last to support Terraform version 0.15, 0.14, 0.13 and 0.12.20+ and Terraform AWS provider 3.x and 2.x.
-->
...
[badge-build]: https://github.com/mineiros-io/terraform-aws-lb-target-group/workflows/Tests/badge.svg

<!-- markdown-link-check-enable -->

[badge-semver]: https://img.shields.io/github/v/tag/mineiros-io/terraform-aws-lb-target-group.svg?label=latest&sort=semver
...
[build-status]: https://github.com/mineiros-io/terraform-aws-lb-target-group/actions
[releases-github]: https://github.com/mineiros-io/terraform-aws-lb-target-group/releases
